...
/** \brief Valida nombres y apellidos (solo letras)
 *
 * \param nombre char*
 * \param len int
 * \return int
...
/** \brief valida edad (entre 0 a 200)
 *
 * \param edad int
 * \return int
 *
...
/** \brief Valida nombres y apellidos (solo letras y espacios)
 *
 * \param nombre char*
 * \param len int
 * \return int
 *
 */
int validarNombreConEspacios(char* nombre)
{
    int retorno=-1;
    int i;
    if(strlen(nombre)>1)
